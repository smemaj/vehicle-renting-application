...
public class JwtUtils {
    ...
    @Value("${vehiclerenting.app.jwtSecret}")
    private String jwtSecret;

    @Value("${vehiclerenting.app.jwtExpirationMs}")
    ...
    public boolean validateJwtToken(String authToken) {
        try {
            ...
            logger.error("JWT signature not valid: {}", e.getMessage());
        } catch (MalformedJwtException e) {
            logger.error("JWT token not valid: {}", e.getMessage());
